...
# Setup WSL2: Step: 4
Write-Information "`n 4. Ensure WSL is updated..."
...
winget install --id 'Canonical.Ubuntu.2404' --exact --dependency-source --accept-source-agreements --accept-package-agreements --silent
...
winget install --id 'Docker.DockerDesktop' --exact --dependency-source --accept-source-agreements --accept-package-agreements --silent
